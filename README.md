.. -*- mode: rst -*-
=====================================
 Keyboards for Indoeuropean languages
=====================================

This directory contains source files and build instructions for developing
keyboards for the Indoeuropean languages. The data and implementations
...
* http://giellatekno.uit.no/inedoc/index.html
* http://divvun.no/doc/tools/docu-ine-manual.html
...
In order to compile and use Indoeuropean keyboards you need:
...
The Indoeuropean keyboard sources can be acquired using the `Giella SVN
repository <http://giellalt.uit.no/infra/anonymous-svn.html>`_, from the
